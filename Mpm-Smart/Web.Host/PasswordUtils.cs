...
public static class Extensions
{
    ...
    /// </remarks>
    public static IResourceBuilder<ParameterResource> CreateStablePassword(this IDistributedApplicationBuilder builder,
        string name,
        ...
        int minLower = 0, int minUpper = 0, int minNumeric = 0, int minSpecial = 0)
    {
        ...
        var parameterResource = new ParameterResource(name,
            parameterDefault => GetParameterValue(builder.Configuration, name, parameterDefault), true)
        {
    ...
    private class UserSecretsParameterDefault(
        string applicationName,
        string parameterName,
        ParameterDefault parameterDefault) : ParameterDefault
    {
        ...
        private static bool TrySetUserSecret(string applicationName, string name, string value)
        {
            ...
            try
            {
                ...
                new List<string>(["user-secrets", "set", name, value, "--id", userSecretsId]).ForEach(startInfo
                    .ArgumentList
                    .Add);
