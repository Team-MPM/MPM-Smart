...
) : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken cancellationToken)
    {
        ...
        m_MetricsFileStream = new FileStream(MetricsFileName, FileMode.OpenOrCreate, FileAccess.ReadWrite, FileShare.Read);
        m_LogsFileStream = new FileStream(LogsFileName, FileMode.OpenOrCreate, FileAccess.ReadWrite, FileShare.Read);
        m_TracesFileStream = new FileStream(TracesFileName, FileMode.OpenOrCreate, FileAccess.ReadWrite, FileShare.Read);
